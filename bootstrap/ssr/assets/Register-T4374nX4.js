...
import { G as Guest } from "./GuestLayout-_-yCLcgu.js";
      ...
      /* @__PURE__ */ jsxs("div", { className: "flex items-center justify-end mt-4", children: [
        ...
        /* @__PURE__ */ jsxs(
          "a",
          {
            ...
            className: "inline-flex items-center gap-2 ms-4 px-4 py-2 bg-gray-800 border border-transparent rounded-md font-semibold text-xs text-white uppercase tracking-widest hover:bg-gray-700 focus:bg-gray-700 active:bg-gray-900 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2 transition ease-in-out duration-150",
            children: [
              /* @__PURE__ */ jsx("span", { children: "Continue with" }),
              /* @__PURE__ */ jsx(FaXTwitter, { className: "h-5 w-5 p-1 border rounded-full" })
            ]
          }
        )
      ] })
